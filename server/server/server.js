...
app.post("/api/v1/user/signup", async (req, res) => {
    try
    {
        ...
        const results = await db.query("INSERT INTO APP_USER (First_name, Last_name, Address, DateOfBirth, mobileNo, Age, password)"+
        "values ($1, $2, ROW($6, $7, $8, $9)::AddressType"+
                    ", $3, $4, CalculateAge($3), $5) returning *", 
                    [req.body.first_name, req.body.last_name, req.body.dateofbirth, req.body.mobileno,
                        sha256(req.body.password), req.body.address[0], req.body.address[1], req.body.address[2], req.body.address[3]]);
